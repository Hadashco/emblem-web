...
const uploadStateToProps = state => {
  return { artModalState: state.upload.artModalState, modalState: state.upload.modalState, files: state.upload.files, toUpload: state.upload.toUpload, currentArt: state.upload.currentArt, isAuthorized: state.auth.isAuthorized, displayColorPicker: state.color.diplayColorPicker };
};
